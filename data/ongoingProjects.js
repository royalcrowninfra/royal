export const projects = [
  {
    ...
    amenities: [
      { name: "SWIMMING POOL", image: "/images/amenities/saiprasad/pool.jpg" },
      { name: "INDOOR GAMES", image: "/images/amenities/saiprasad/game.jpg" },
      { name: "KIDS PLAY AREA", image: "/images/amenities/saiprasad/kidsplayarea2.jpg" },
      { name: "GYM", image: "/images/amenities/saiprasad/gym.jpg" },
      { name: "AMPLE CAR PARKING", image: "/images/amenities/saiprasad/parking.png" },
      { name: "SENIOR CITIZEN SEATING", image: "/images/amenities/saiprasad/seniorCitizensSeating.jpg" },
    ],
    floorplans: [
      { title: '1 BHK Floor Plan', src: '/images/floorplans/ongoing/saiprasad/img-10.jpeg' },
      { title: '2 BHK Floor Plan', src: '/images/floorplans/ongoing/saiprasad/img-11.jpeg' },
  ...
  },
  {
    ...
    amenities: [
      ...
      { name: "Yoga Deck", image: "/images/amenities/jayram/yoga.jpg" },
      { name: "Senior Citizen Sitout Area", image: "/images/amenities/jayram/seniorcitizenseating.jpg" },
      { name: "Jogging Track", image: "/images/amenities/jayram/jogging.jpg" },
      { name: "High Speed Elevators", image: "/images/amenities/jayram/lift.jpg" },
      { name: "Power Backup for Common Area", image: "/images/amenities/jayram/generator.jpg" },
    ],
    floorplans: [
    ...
    connectivity: [
      ...
      { icon: "PlaneIcon", title: "Navi Mumbai International Airport", description: "Navi Mumbai International Airport : 15 Mins Drive" },
      { icon: "ComputerIcon", title: "IT park", description: "Panvel Railway Station : 15 Mins Drive" },
      { icon: "TrainFrontIcon", title: "Metro Station", description: "Navi Mumbai International Airport : 15 Mins Drive" },
      { icon: "Building2Icon", title: "Malls", description: "Shopping Centers : Drive to Dmart – 5 mins" },
      { icon: "SchoolIcon", title: "Schools and Colleges", description: "Schools & Colleges : All Reputed Schools and Colleges – 1-2 Km Radius" },
      { icon: "SchoolIcon", title: "Schools and Colleges", description: "Shopping Centers : Drive to Dmart – 5 mins" },
      { icon: "SchoolIcon", title: "Schools and Colleges", description: "Mumbai Pune Expressway  and Old Mumbai Pune Highway – 2Mins Drive" },
    ],
    highlights: [
      { icon: "Building2", description: "TOWNSHIP IN 3 ACRES" },
      { icon: "Home", description: "4 RESIDENTIAL BUILDINGS WITH 10 WINGS" },
      { icon: "Banknote", description: "STILT + 7 STOREY WITH LIFT" },
      { icon: "FileCheck", description: "LUXURIOUS AND AFFORDABLE 1 AND 2 BHK RESIDENCES" },
      { icon: "CheckSquare", description: "ROJECT APPROVED BY MSRDC" },
    ],
    configuration: [
      { flat: "1 BHK", carpet: "400 SQ FT" },
      { flat: "1 BHK", carpet: "411 SQ FT" },
      { flat: "1 BHK", carpet: "422 SQ FT" },
      { flat: "2 BHK", carpet: "598 SQ FT" },
      { flat: "2 BHK", carpet: "613 SQ FT" }
    ],
    map: {
      center: { lat: 19.009816908187975, lng: 73.10259316005418 },
      zoom: 14,
  ...
  },
  {
    ...
    amenities: [
      { name: "Gymnasium", image: "/images/amenities/pool.jpg" },
      { name: "Indoor Games", image: "/images/amenities/carParking.jpg" },
      { name: "Society Office", image: "/images/amenities/game.jpg" },
      { name: "Rooftop Yoga Deck", image: "/images/amenities/garden.jpg" },
      { name: "Rooftop Gazebo", image: "/images/amenities/gym.jpg" },
      { name: "Rooftop Garden", image: "/images/amenities/lift.jpg" },
      { name: "Childrens Play Area", image: "/images/amenities/lift.jpg" },
    ...
    connectivity: [
      ...
      { icon: "PlaneIcon", title: "Navi Mumbai International Airport", description: "NAVI MUMBAI INTERNATIONAL AIRPORT :2 Mins" },
      { icon: "ComputerIcon", title: "IT park", description: "Reliance SEZ and IT Park : 0.5 Kms" },
      { icon: "TrainFrontIcon", title: "Metro Station", description: "UPCOMING KALAMBOLI METRO STATION : 1.5 KMS" },
      { icon: "Building2Icon", title: "Sports Academy", description: "Close to Karnala Sports Academy" },
    ...
    galleryImages: [
      { image: "/images/projects/ongoing/newcityPalace/left.jpg", alt: "Exterior View" },
      { image: "/images/projects/ongoing/newcityPalace/right.jpg", alt: "Living Room" },
      { image: "/images/projects/ongoing/newcityPalace/ISO.jpg", alt: "Kitchen" },
      { image: "/images/projects/ongoing/newcityPalace/nightRender1.jpg", alt: "Kitchen" },
      { image: "/images/projects/ongoing/newcityPalace/terraceRender.jpg", alt: "Kitchen" },
    ],
  },
  {
    slug: "project-4",
