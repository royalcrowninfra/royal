...
const HeroSection = () => {
  ...
  return (
    <div className="relative">
      ...
      <div className="relative bottom-10 left-1/2 transform -translate-x-1/2 w-8/12 bg-gradient-to-r from-teal-700 via-blue-500 to-purple-500 py-4 sm:py-6 md:py-6">
