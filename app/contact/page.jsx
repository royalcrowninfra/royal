  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-blue-100 via-white to-purple-100 text-gray-800'>
      <motion.div
        ...
        style={{
          backgroundImage: "url('/images/contact/contactBackground.jpg')",
        }}
      >
            ...
            <motion.div variants={itemVariants} className='mb-8 space-y-4'>
              ...
              >
                <p className='text-lg md:text-center'>
                  ROYAL CROWN INFRA Shop No 1 Sector 25 Plot No 19, Ravi Rachna,
                  near Khandeshwar Station, Sector-25, Khandeshwar, Navi Mumbai,
                  Maharashtra 410209
                </p>
              </motion.div>
              <motion.div
