...
const EMICalculator = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-yellow-50 rounded-lg shadow-lg">
      <h1 className="text-2xl font-bold text-center text-red-600 mb-6">EMI Calculator</h1>
          ...
          <table className="w-full">
            <tbody>
              ...
              <tr>
                ...
                <td className="text-right">{formatter.format(totalInterest)}</td>
              </tr>
              <tr>
