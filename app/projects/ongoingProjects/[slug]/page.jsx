...
export default function ProjectPage({ params }) {
  ...
  return (
    <div className="bg-gradient-to-b from-white-100 to-white min-h-screen flex justify-center">
        ...
        <section className=' py-8'>
          <div className='flex flex-col lg:flex-row items-start'>
            <div className='lg:w-1/2 lg:pr-6 text-center'>
              ...
              <p className='mb-4 text-sm md:text-base font-semibold text-black text-center'>
          ...
          <div className="mt-0 flex justify-center lg:justify-start md:px-44">
